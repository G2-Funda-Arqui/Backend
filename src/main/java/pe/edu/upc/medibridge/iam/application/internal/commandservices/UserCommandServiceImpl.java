...
import pe.edu.upc.medibridge.iam.domain.model.events.UserRegisteredEvent;
...
public class UserCommandServiceImpl implements UserCommandService {
    ...
    public Optional<User> handle(SignUpCommand command) {
        ...
        // Se crea evento de dominio luego de guardar el usuario en el repository
        eventPublisher.publishEvent(new UserRegisteredEvent(savedUser.getId(), savedUser.getUsername()));
