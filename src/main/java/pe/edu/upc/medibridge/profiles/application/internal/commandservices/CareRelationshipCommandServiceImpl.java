...
import pe.edu.upc.medibridge.profiles.domain.model.events.DoctorAssignedToPatientEvent;
import pe.edu.upc.medibridge.profiles.domain.model.events.FamilyMemberLinkedToPatientEvent;
...
public class CareRelationshipCommandServiceImpl implements CareRelationshipCommandService {
    ...
    public Optional<DoctorPatientAssignment> handle(AssignDoctorToPatientCommand command) {
        ...
        eventPublisher.publishEvent(new DoctorAssignedToPatientEvent(
                assignment.getId(),
    ...
    public Optional<FamilyPatientLink> handle(LinkFamilyMemberToPatientCommand command) {
        ...
        eventPublisher.publishEvent(new FamilyMemberLinkedToPatientEvent(
                link.getId(),
